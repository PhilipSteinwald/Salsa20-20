...
{
  (void) ivbits; // void cast, because it was an unused variable - shouldn't change functionality
  int i;
  (void) i; // void cast, because it was an unused variable - shouldn't change functionality
...
//bytes = number of chars
//c = cipher
// m = message
void ECRYPT_encrypt_bytes(ECRYPT_ctx *x,const u8 *m,u8 *c,u32 bytes)
{
  u8 output[64];
  u32 i; // changed from int to u32 because it compiled with warning - shouldn't change functionality
